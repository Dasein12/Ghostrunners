...
{
    SDL_Surface  *ecran = NULL, *imageDeFond = NULL, *image1 = NULL,*image2 = NULL, *image3=NULL,*image5=NULL,*image6=NULL, *image1a = NULL,*image2a = NULL, *image3a=NULL,*image8=NULL,*image9=NULL, *image10 = NULL,*image11 = NULL, *image12=NULL,*image13=NULL,*image14=NULL,*image15=NULL,*image16=NULL,*image10a = NULL,*image11a = NULL,*title=NULL, *image12a=NULL,*image13a=NULL,*image14a=NULL,*image15a=NULL,*image16a=NULL,*text=NULL, *imageDeFond1 = NULL ; 
    SDL_Rect positiontext,positionFond,positionimage1, positionimage2,positionimage3,positionclic,positionimage5,positionimage6,positionimage8,positionimage9,positionimage1a, positionimage2a,positionimage3a, positionimage4a,positionimage11, positionimage12,positionimage13, positionimage14,positionimage15,positionimage16,positionimage10,positionimage11a, positionimage12a,positionimage13a, positionimage14a,positionimage15a,positionimage16a,positionimage10a,positiontitle,positionFond1;
...
// INIT VIDEO
    ...
    SDL_WM_SetCaption("The Flesh Prevails ", NULL);
//VERIF
    if( ecran == NULL )
    {
...
//MENU BUTTONS 
    ...
    image6 = IMG_Load("image6.png"); // option background

    image5 = IMG_Load("image5.png"); // game
...
while (c<100) 
	...
	SDL_BlitSurface(imageDeFond1,&positionFond1,ecran,NULL);
	...
	if(c>=10)
	{
		sprintf(intro,"intro/frame_0%d_delay-0.05s.png",c);
	SDL_Delay(20);
	imageDeFond1 = IMG_Load(intro);
	}
c++;
...
//done=0 means exit  et k designe le choix selectionnee
	...
	if(counterr<=122)
	{
	sprintf(animation,"animation/ASSET_000%d.png",counterr);
	SDL_Delay(30);
	...
	counterr++;
                ...
                police=TTF_OpenFont("font.ttf",90);
                title=TTF_RenderText_Solid(police,"The Flesh Prevails ",red);
            ...
            while(SDL_PollEvent(&event))
            {
                ...
                case SDL_MOUSEBUTTONDOWN:
                {
                    if (event.button.button ==SDL_BUTTON_LEFT)
                    {
                        ...
                        {
                            ecran = SDL_SetVideoMode(1440,900, 32, SDL_HWSURFACE|SDL_DOUBLEBUF|SDL_FULLSCREEN);
                            Mix_PlayChannel(-1,son,0);
                        }
